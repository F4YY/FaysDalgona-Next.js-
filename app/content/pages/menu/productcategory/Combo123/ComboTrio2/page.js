...
const ComboTrio2 = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Combo Trio 2");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Combo" && menu.items[1].name === "Combo 123" && menu.items[1].list[5].name === "Combo Trio 2");
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ComboTrio2.jpg`} alt={props.items[1].list[5].name} width={50} height={50}/>
