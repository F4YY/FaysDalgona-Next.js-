...
const ComboDuo2 = ({
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Combo Duo 2");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Combo" && menu.items[1].name === "Combo 123" && menu.items[1].list[3].name === "Combo Duo 2");
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img loading="lazy" src={require(`../../../../../../images/${props.items[1].list[3].image}`)} alt={props.items[1].list[3].name} />
        <ProductDesc>
          <ItemName>{props.items[1].list[3].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[1].list[3].stars}★
              </Rating>
              <TextReview>
                {props.items[1].list[3].reviews}&nbsp;reviews
              </TextReview>
            </StarsReview>
            {authReady && (
              <h2
          ...
          <DetailDesc>{props.items[1].list[3].description}</DetailDesc>
          <Calory>{props.items[1].list[3].calories}</Calory>
        </ProductDesc>
      </ProductHero>
      <ProductInfoOrder>
        <SizeAndOrder>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../../../images/ComboDuo2.jpg')} alt={props.items[1].list[3].name} />
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ComboDuo2.jpg');
                  setMenuCategory(props.items[1].name);
                  setMenuName(props.items[1].list[3].name);
                }}
