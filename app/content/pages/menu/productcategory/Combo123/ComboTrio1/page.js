...
const ComboTrio1 = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Combo Trio 1");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Combo" && menu.items[1].name === "Combo 123" && menu.items[1].list[4].name === "Combo Trio 1");
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={`/images/${props.items[1].list[4].image}`} alt={props.items[1].list[4].name} width={500} height={500}/>
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ComboTrio1.jpg`} alt={props.items[1].list[4].name} width={50} height={50}/>
