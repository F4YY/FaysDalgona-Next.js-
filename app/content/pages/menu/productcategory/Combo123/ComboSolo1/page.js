...
const ComboSolo1 = () => {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Combo" && menu.items[1].name === "Combo 123" && menu.items[1].list[0].name === "Combo Solo 1");
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ComboSolo1.jpg`} alt={props.items[1].list[0].name} width={50} height={50}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ComboSolo1.jpg');
                  setMenuCategory(props.items[1].name);
                  setMenuName(props.items[1].name);
                }}
