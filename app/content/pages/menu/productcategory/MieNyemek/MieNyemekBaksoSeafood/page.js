...
const MieNyemekBaksoSeafood = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Mie Nyemek Bakso Seafood");
      if (matchingObject) {
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/mienyemek_baksoseafood.jpg`} alt={props.items[0].list[2].name} width={50} height={50}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('mienyemek_baksoseafood.jpg');
...
export default MieNyemekBaksoSeafood;
