...
const DalgonaChocMilo = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Dalgona Choco Milo");
      if (matchingObject) {
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/Dalg_ChocMilo.jpg`} alt={props.items[0].list[4].name} width={50} height={50}/>
...
export default DalgonaChocMilo;
