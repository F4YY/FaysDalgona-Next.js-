...
const DalgonaGreenTea = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Dalgona Green Tea");
      if (matchingObject) {
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/Dalg_Greentea.jpg`} alt={props.items[0].list[2].name} width={50} height={50}/>
...
export default DalgonaGreenTea;
