...
const DalgonaOriThaiTea = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Dalgona Original Thai Tea");
      if (matchingObject) {
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={`/images/${props.items[0].list[3].image}`} alt={props.items[0].list[3].name} width={500} height={500}/>
        <ProductDesc>
          <ItemName>{props.items[0].list[3].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[0].list[3].stars}★
              </Rating>
              <TextReview>
                {props.items[0].list[3].reviews}&nbsp;reviews
              </TextReview>
            </StarsReview>
            {authReady && (
              <h2
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/Dalg_Orithaitea.jpg`} alt={props.items[0].list[3].name} width={50} height={50}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('Dalg_Orithaitea.jpg');
                  setMenuCategory(props.items[0].name);
                  setMenuName(props.items[0].list[3].name);
                }}
...
export default DalgonaOriThaiTea;
