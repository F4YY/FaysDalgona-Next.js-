...
const DalgonaTaro = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Dalgona Taro");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Drinks" && menu.items[0].name === "Dalgona Iced" && menu.items[0].list[7].name === "Dalgona Taro");
  ...
  return (
    ...
    >
      <PathAndBackButton>
        <Path>
          ...
          <Slash>/</Slash>
          <ItemText>{props.items[0].list[7].name}</ItemText>
        </Path>
        <Link href="/content/pages/menu/productcategory/DalgonaIced">
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={`/images/${props.items[0].list[7].image}`} alt={props.items[0].list[7].name} width={500} height={500}/>
        <ProductDesc>
          <ItemName>{props.items[0].list[7].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[0].list[7].stars}★
              </Rating>
              <TextReview>
                {props.items[0].list[7].reviews}&nbsp;reviews
              </TextReview>
            </StarsReview>
            {authReady && (
              <h2
          ...
          <DetailDesc>{props.items[0].list[7].description}</DetailDesc>
          <Calory>{props.items[0].list[7].calories}</Calory>
        </ProductDesc>
      </ProductHero>
      <ProductInfoOrder>
        <SizeAndOrder>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/Dalg_Taro.jpg`} alt={props.items[0].list[7].name} width={50} height={50}/>
          <RatingItemName>{props.items[0].list[7].name}</RatingItemName>
        </RatingMenuWrap>
        <YellowStars>
          {stars.map((_, index) => {
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('Dalg_Taro.jpg');
                  setMenuCategory(props.items[0].name);
                  setMenuName(props.items[0].list[7].name);
                }}
