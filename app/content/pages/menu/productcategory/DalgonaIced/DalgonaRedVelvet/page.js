...
const DalgonaRedV = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Dalgona Red Velvet");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Drinks" && menu.items[0].name === "Dalgona Iced" && menu.items[0].list[6].name === "Dalgona Red Velvet");
  ...
  return (
    ...
    >
      <PathAndBackButton>
        <Path>
          ...
          <Slash>/</Slash>
          <ItemText>{props.items[0].list[6].name}</ItemText>
        </Path>
        <Link href="/content/pages/menu/productcategory/DalgonaIced">
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={`/images/${props.items[0].list[6].image}`} alt={props.items[0].list[6].name} width={500} height={500}/>
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/Dalg_RedV.jpg`} alt={props.items[0].list[6].name} width={50} height={50}/>
          <RatingItemName>{props.items[0].list[6].name}</RatingItemName>
        </RatingMenuWrap>
        <YellowStars>
          {stars.map((_, index) => {
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('Dalg_RedV.jpg');
                  setMenuCategory(props.items[0].name);
                  setMenuName(props.items[0].list[6].name);
                }}
