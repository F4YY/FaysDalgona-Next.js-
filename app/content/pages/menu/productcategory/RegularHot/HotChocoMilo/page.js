...
const HotChocMilo = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Hot Choco Milo");
      if (matchingObject) {
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[2].background}>
        <Img src={`/images/${props.items[2].list[4].image}`} alt={props.items[2].list[4].name} width={500} height={500}/>
        <ProductDesc>
          <ItemName>{props.items[2].list[4].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[2].list[4].stars}★
              </Rating>
              <TextReview>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ReguHot_ChocMilo.jpg`} alt={props.items[2].list[4].name} width={50} height={50}/>
          <RatingItemName>{props.items[2].list[4].name}</RatingItemName>
        </RatingMenuWrap>
        <YellowStars>
          {stars.map((_, index) => {
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguHot_ChocMilo.jpg');
                  setMenuCategory(props.items[2].name);
                  setMenuName(props.items[2].list[4].name);
                }}
