  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[2].background}>
        <Img src={require(`../../../../../../images/${props.items[2].list[1].image}`)} alt={props.items[2].list[1].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={require('../../../../../../images/ReguHot_Capu.jpg')} alt={props.items[2].list[1].name} />
