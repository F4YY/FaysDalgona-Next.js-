  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[2].background}>
        <Img src={`/images/${props.items[2].list[7].image}`} alt={props.items[2].list[7].name} width={500} height={500}/>
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ReguHot_Taro.jpg`} alt={props.items[2].list[7].name} width={50} height={50}/>
