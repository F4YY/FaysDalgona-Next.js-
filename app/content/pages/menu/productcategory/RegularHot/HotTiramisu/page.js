  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[2].background}>
        <Img src={require(`../../../../../../images/${props.items[2].list[9].image}`)} alt={props.items[2].list[9].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={require('../../../../../../images/ReguHot_Tira.jpg')} alt={props.items[2].list[9].name} />
