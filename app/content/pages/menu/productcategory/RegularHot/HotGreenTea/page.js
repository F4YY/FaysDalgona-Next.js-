...
const HotGreentea = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Hot Green Tea");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Drinks" && menu.items[2].name === "Regular Hot" && menu.items[2].list[2].name === "Hot Green Tea");
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[2].background}>
        <Img src={`/images/${props.items[2].list[2].image}`} alt={props.items[2].list[2].name} width={500} height={500}/>
        <ProductDesc>
          <ItemName>{props.items[2].list[2].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[2].list[2].stars}★
              </Rating>
              <TextReview>
                {props.items[2].list[2].reviews}&nbsp;reviews
              </TextReview>
            </StarsReview>
            {authReady && (
              <h2
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ReguHot_Greentea.jpg`} alt={props.items[2].list[2].name} width={50} height={50}/>
          <RatingItemName>{props.items[2].list[2].name}</RatingItemName>
        </RatingMenuWrap>
        <YellowStars>
          {stars.map((_, index) => {
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguHot_Greentea.jpg');
                  setMenuCategory(props.items[2].name);
                  setMenuName(props.items[2].list[2].name);
                }}
