  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[2].background}>
        <Img src={require(`../../../../../../images/${props.items[2].list[5].image}`)} alt={props.items[2].list[5].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={require('../../../../../../images/ReguHot_Moca.jpg')} alt={props.items[2].list[5].name} />
