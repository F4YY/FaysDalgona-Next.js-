...
const CapuccinoIced = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Capuccino Iced");
      if (matchingObject) {
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={require(`../../../../../../images/${props.items[1].list[1].image}`)} alt={props.items[1].list[1].name} />
        <ProductDesc>
          <ItemName>{props.items[1].list[1].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[1].list[1].stars}★
              </Rating>
              <TextReview>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={require('../../../../../../images/ReguIced_Capu.jpg')} alt={props.items[1].list[1].name} priority/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguIced_Capu.jpg');
                  setMenuCategory(props.items[1].name);
                  setMenuName(props.items[1].list[1].name);
                }}
