...
const NescafeIced = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Nescafe Classic Iced");
      if (matchingObject) {
  ...
  return (
    ...
    >
      <PathAndBackButton>
        <Path>
          ...
          <Slash>/</Slash>
          <ItemText>{props.items[1].list[8].name}</ItemText>
        </Path>
        <Link href="/content/pages/menu/productcategory/RegularIced">
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={`/images/${props.items[1].list[8].image}`} alt={props.items[1].list[8].name} width={500} height={500}/>
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ReguIced_Nescafe.jpeg`} alt={props.items[1].list[8].name} width={50} height={50}/>
          <RatingItemName>{props.items[1].list[8].name}</RatingItemName>
        </RatingMenuWrap>
        <YellowStars>
          {stars.map((_, index) => {
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguIced_Nescafe.jpeg');
                  setMenuCategory(props.items[1].name);
                  setMenuName(props.items[1].list[8].name);
                }}
