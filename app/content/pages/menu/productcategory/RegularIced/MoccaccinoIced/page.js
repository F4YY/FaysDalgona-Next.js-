...
const MoccaIced = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Moccaccino Iced");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Drinks" && menu.items[1].name === "Regular Iced" && menu.items[1].list[5].name === "Moccaccino Iced");
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={`/images/${props.items[1].list[5].image}`} alt={props.items[1].list[5].name} width={500} height={500}/>
        <ProductDesc>
          <ItemName>{props.items[1].list[5].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[1].list[5].stars}★
              </Rating>
              <TextReview>
                {props.items[1].list[5].reviews}&nbsp;reviews
              </TextReview>
            </StarsReview>
            {authReady && (
              <h2
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ReguIced_Moca.jpg`} alt={props.items[1].list[5].name} width={50} height={50}/>
          <RatingItemName>{props.items[1].list[5].name}</RatingItemName>
        </RatingMenuWrap>
        <YellowStars>
          {stars.map((_, index) => {
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguIced_Moca.jpg');
                  setMenuCategory(props.items[1].name);
                  setMenuName(props.items[1].list[5].name);
                }}
