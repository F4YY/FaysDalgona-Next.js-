  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={require(`../../../../../../images/${props.items[1].list[2].image}`)} alt={props.items[1].list[2].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={require('../../../../../../images/ReguIced_Greentea.jpg')} alt={props.items[1].list[2].name} />
