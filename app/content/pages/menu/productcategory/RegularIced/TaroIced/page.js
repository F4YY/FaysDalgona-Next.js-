  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={require(`../../../../../../images/${props.items[1].list[7].image}`)} alt={props.items[1].list[7].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={require('../../../../../../images/ReguIced_Taro.jpg')} alt={props.items[1].list[7].name} />
