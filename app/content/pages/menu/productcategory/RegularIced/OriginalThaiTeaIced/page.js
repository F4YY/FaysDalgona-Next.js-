...
const OriThaiTeaIced = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Original Thai Tea Iced");
      if (matchingObject) {
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={require(`../../../../../../images/${props.items[1].list[3].image}`)} alt={props.items[1].list[3].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={require('../../../../../../images/ReguIced_Orithaitea.jpg')} alt={props.items[1].list[3].name} />
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguIced_Orithaitea.jpg');
