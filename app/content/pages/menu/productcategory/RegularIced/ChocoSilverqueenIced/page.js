...
const ChocSilvIced = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Choco Silverqueen Iced");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Drinks" && menu.items[1].name === "Regular Iced" && menu.items[1].list[0].name === "Choco Silverqueen Iced");
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={`/images/${props.items[1].list[0].image}`} alt={props.items[1].list[0].name} width={500} height={500}/>
        <ProductDesc>
          <ItemName>{props.items[1].list[0].name}</ItemName>
          <RatingWrap>
            <StarsReview>
              <Rating>
                {props.items[1].list[0].stars}★
              </Rating>
              <TextReview>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ReguIced_ChocSilv.jpg`} alt={props.items[1].list[0].name} width={50} height={50}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguIced_ChocSilv.jpg');
