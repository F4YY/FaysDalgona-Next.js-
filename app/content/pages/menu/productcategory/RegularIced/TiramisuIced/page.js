...
const TiramisuIced = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "Tiramisu Iced");
      if (matchingObject) {
  ...
  return (
    ...
    >
      <PathAndBackButton>
        <Path>
          ...
          <Slash>/</Slash>
          <ItemText>{props.items[1].list[9].name}</ItemText>
        </Path>
        <Link href="/content/pages/menu/productcategory/RegularIced">
      ...
      <ProductHero $background={props.items[1].background}>
        <Img src={`/images/${props.items[1].list[9].image}`} alt={props.items[1].list[9].name} width={500} height={500}/>
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/ReguIced_Tira.jpg`} alt={props.items[1].list[9].name} width={50} height={50}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('ReguIced_Tira.jpg');
                  setMenuCategory(props.items[1].name);
                  setMenuName(props.items[1].list[9].name);
                }}
