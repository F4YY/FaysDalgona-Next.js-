  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={require(`../../../../../../images/${props.items[0].list[6].image}`)} alt={props.items[0].list[6].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../../../images/DalCro_RedV.jpg')} alt='dal cro capu' />
