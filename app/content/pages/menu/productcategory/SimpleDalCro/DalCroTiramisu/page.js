...
const DalCroTira = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "DalCro Tiramisu");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Combo" && menu.items[0].name === "Simple DalCro" && menu.items[0].list[9].name === "DalCro Tiramisu");
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={require(`../../../../../../images/${props.items[0].list[9].image}`)} alt={props.items[0].list[9].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../../../images/DalCro_Tira.jpg')} alt='dal cro capu' />
