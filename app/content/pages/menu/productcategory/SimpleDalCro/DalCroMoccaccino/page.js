...
const DalCroMocca = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "DalCro Moccaccino");
      if (matchingObject) {
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={`/images/${props.items[0].list[5].image}`} alt={props.items[0].list[5].name} width={500} height={500}/>
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/DalCro_Mocca.jpg`} alt='dal cro capu' width={50} height={50}/>
