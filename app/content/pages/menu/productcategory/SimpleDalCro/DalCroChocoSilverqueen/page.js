...
const DalCroChocSilv = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "DalCro Choco Silverqueen");
      if (matchingObject) {
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/DalCro_ChocSilv.jpg`} alt='dal cro capu' width={50} height={50}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('DalCro_ChocSilv.jpg');
