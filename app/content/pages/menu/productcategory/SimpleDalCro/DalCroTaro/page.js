  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={require(`../../../../../../images/${props.items[0].list[7].image}`)} alt={props.items[0].list[7].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../../../images/DalCro_Taro.jpg')} alt='dal cro capu' />
