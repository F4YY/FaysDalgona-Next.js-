...
const DalCroTaro = () => {
  ...
  React.useEffect(() => {
    ...
    .then(data => {
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "DalCro Taro");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Combo" && menu.items[0].name === "Simple DalCro" && menu.items[0].list[7].name === "DalCro Taro");
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/DalCro_Taro.jpg`} alt='dal cro capu' width={50} height={50}/>
