...
const DalCroOriThaiTea = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "DalCro Original Thai Tea");
      if (matchingObject) {
  ...
  return (
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/DalCro_Orithaitea.jpg`} alt='dal cro capu' width={50} height={50}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('DalCro_Orithaitea.jpg');
...
export default DalCroOriThaiTea;