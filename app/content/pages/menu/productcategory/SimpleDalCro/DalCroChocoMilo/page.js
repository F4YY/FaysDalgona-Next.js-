...
const DalCroChocMilo = () => {
  ...
  React.useEffect(() => {
    ...
    async function getDataFromFirestore() {
      ...
      const matchingObject = data.find(obj => obj.name === user?.user_metadata.full_name && obj.menu_name === "DalCro Choco Milo");
      if (matchingObject) {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Combo" && menu.items[0].name === "Simple DalCro" && menu.items[0].list[4].name === "DalCro Choco Milo");
  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={`/images/${props.items[0].list[4].image}`} alt={props.items[0].list[4].name} width={500} height={500}/>
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/DalCro_ChocMilo.jpg`} alt='dal cro capu' width={50} height={50}/>
          <RatingItemName>{props.items[0].list[4].name}</RatingItemName>
        </RatingMenuWrap>
        <YellowStars>
          {stars.map((_, index) => {
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('DalCro_ChocMilo.jpg');
                  setMenuCategory(props.items[0].name);
                  setMenuName(props.items[0].list[4].name);
                }}
