  ...
  return (
    ...
    >
      ...
      <ProductHero $background={props.items[0].background}>
        <Img src={require(`../../../../../../images/${props.items[0].list[4].image}`)} alt={props.items[0].list[4].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../../../images/DalCro_ChocMilo.jpg')} alt='dal cro capu' />
