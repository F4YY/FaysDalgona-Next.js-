...
const CroffleOriginal = () => {
  ...
  const props = menudata.menu.find((menu) => menu.category === "Food" && menu.items[1].name === "Croffle" && menu.items[1].list[0].name === "Croffle Original");
  ...
  return (
    ...
    >
      <PathAndBackButton>
        <Path>
          ...
          <Slash>/</Slash>
          <Link href='/content/pages/menu/productcategory/Croffle'>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg src={`/images/CroffleOriginal.jpg`} alt={props.items[1].list[0].name} width={200} height={200}/>
            ...
            return (
              <StarIcon
                ...
                onClick={() => {
                  ...
                  setMenuPic('CroffleOriginal.jpg');
...
export default CroffleOriginal;
